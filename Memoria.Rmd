...
El segundo script se llama *producer_consumer_parse_notify_reviews.py* y se encarga de gestionar los mensajes del topic *raw_albums* y obtener los campos de _título, puntaje, artistas, género, imagen, año y etiqueta_, para posteriormente filtrar los de puntaje superior a 8 y devolverlos como recomendados.
...
A continuación ejecutamos el segundo script (*producer_consumer_parse_notify_reviews.py*), que únicamente crea un Consumidor y lee los mensajes del topic *raw_albums*, para procesarlos y mostrar los de puntaje superior a 8. Obtenemos el siguiente output.
...
Processing..https://pitchfork.com/reviews/albums/slauson-malone-a-quiet-farwell-or-twenty-sixteen-to-twenty-eighteen/
Processing..https://pitchfork.com/reviews/albums/jade-bird-jade-bird/
Processing..https://pitchfork.com/reviews/albums/grace-ives-2nd/
Processing..https://pitchfork.com/reviews/albums/03-greedo-still-summer-in-the-projects/
Processing..https://pitchfork.com/reviews/albums/kornel-kovacs-stockholm-marathon/
Añadidos  12  álbums
Enviando albums.
Enviados  24  albums.
Enviando links.
...
Vemos que el primer álbum no aparece duplicado, ya que solo tenemos un registro del mismo presente en el topic *raw_albums*. Además, se han añadido 4 nuevos álbumes con puntaje superior a 8 provenientes de las páginas 2 y 3.
